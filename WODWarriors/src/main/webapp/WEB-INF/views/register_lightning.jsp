...
<head>
    ...
    <script>
	    ...
	    function validateForm(f) {
	        ...
	        .then(response => {
	        	console.log(response);  // response 객체를 출력하여 상태 확인
	            if (!response.ok) {
    ...
    <div class="container">
        ...
        <form>
            ...
            <div>
                ...
                <input type="radio" id="running" name="exercise" value="running" onclick="showOptions()"> 런닝
                <input type="radio" id="bodybuilding" name="exercise" value="bodybuilding" onclick="showOptions()"> 바디빌딩
                <input type="radio" id="yoga" name="exercise" value="yoga" onclick="showOptions()"> 요가
                <input type="radio" id="hiking" name="exercise" value="hiking" onclick="showOptions()"> 등산
            </div>
            ...
            <div>
                ...
                <input type="number" id="recruitment" name="recruitment" >
            </div>
            <div>
